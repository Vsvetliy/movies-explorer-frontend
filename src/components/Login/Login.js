...
const Login = () => {
    return (
      <div className = "login">
            ...
            <input defaultValue = "TextText" type="email" id="email" className = "login-form__input" name="email" required></input>
          </div>

          <div className = "login-form__inputBox"> 
            <label htmlFor="password" className = "login-form__label">Пароль</label>
            <input type = "password" defaultValue = "TextText" className = "login-form__input login-form__input_pass" maxLength="20" minLength="2" id="password" name="password" required></input>
          </div>

            </form>
            <button  type = "submit" name = "submit-button" className = "login-submit">Войти</button>
